...
export default function AccountNav() {
  ...
  return (
    <nav className="w-full flex justify-center mt-8 gap-1 mb-8">
      ...
      <Link className={linkClasses("details")} to={"/host/details"}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 9m0-1.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm0 4.5v6m0 0h.01M12 14.25h.01"
          />
